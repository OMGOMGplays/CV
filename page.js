...
const TEXTS =
    [
        "Jag heter Loke Vigstrand, jag är 17 år gammal, och jag är en person som är väldigt dator fokuserad. Redan sedans jag var ung så höll jag på med datorer, spelade dator spel, och kunde navigera en dator olikt andra som var vid samma ålder. Bara för tre år sedan så började jag programmera, men redan så tycker vissa att jag är en väldigt duktig programmerare. Jag gillar även att animera i 3D, oftast med ett program som heter \"Source Filmmaker\". Just det programmet fick mig till slut att börja programmera, och jag lärde mig C#. Sedans dess har jag försökt utvidga mina förståelser av andra programmeringsspråk, t.ex. på C++/C.",
        ...
        "Min E-Mail är loke@jenjen.se, och min mobiltelefon kan nås från 073-1XX-XX-XX. Jag har också ett youtube konto, ett steam konto, och ett discord konto, där man kan hitta sätt att kommunikera med mig."
    ]
